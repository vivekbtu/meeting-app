...
export const sendPreOffer = (callType, calleePersonalCode) => {
  ...
  if (
    ...
    // console.log("emmiting pre-offer", data)
...
export const leaveCall = () => {
  try{
      ...
      const localStream = store.setRemoteStream(null);
      if (localStream) {
      ...
      console.log(err);
      console.log("error occured when trying to leave the call");
  }
};
